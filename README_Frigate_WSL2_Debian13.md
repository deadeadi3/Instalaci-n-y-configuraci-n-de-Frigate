...
# PARTE XIV — Buenas prácticas para GitHub

Nunca publicar:

- Contraseñas
- URLs RTSP con usuario y contraseña
- IPs públicas
- Tokens
- Certificados privados
- Archivos de base de datos
- Grabaciones
- Fotografías de cámaras reales
...
Puedes publicar una configuración de ejemplo con valores ficticios.

---

# PARTE XV — Estructura recomendada del repositorio
...
│   ├── instalacion-frigate.md
│   ├── configuracion-camaras.md
│   └── deteccion-personas-perros.md
└── .gitignore
```
...
# PARTE XVI — Guion recomendado para un vídeo de YouTube
...
Mostrar la instalación desde el repositorio oficial.
...
y explicar filtros y umbrales.

## 9. Configurar grabación
...
Explicar CPU, GPU y aceleración.
...
- Microsoft Learn — Instalar WSL: https://learn.microsoft.com/windows/wsl/install
- Microsoft Learn — Comandos básicos de WSL: https://learn.microsoft.com/windows/wsl/basic-commands
- Docker Docs — Instalar Docker Engine en Debian: https://docs.docker.com/engine/install/debian/
- Frigate Docs — Getting Started: https://docs.frigate.video/guides/getting_started/
- Frigate Docs — Instalación: https://docs.frigate.video/frigate/installation/
- Frigate Docs — Configuración de cámaras: https://docs.frigate.video/frigate/camera_setup/
- Frigate Docs — Objetos: https://docs.frigate.video/configuration/objects/
- Frigate Docs — Grabación: https://docs.frigate.video/configuration/record/

---

## Estado de referencia de este laboratorio

Al finalizar esta guía de referencia:
